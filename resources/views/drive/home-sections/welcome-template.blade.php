<div id="page--home">
    ...
    @include('drive.mobile-home')

    <!-- Header 1 -->
    <header class="pt-195 d-none d-md-block" data-bg-src-2x="uploads/bg.png" data-bg-src="uploads/bg.png"
        id="welcome-header">
        <div data-bg-src-2x="false">
            ...
            <div class="mw-600 mx-auto mt-30 f-22 color-heading text-center text-adaptive" data-aos="fade-down"
                data-aos-delay="250">
                Switch to the only cloud storage service that truly respects your privacy. End-to-end encrypted, free,
                open
